							...
							<div className="row form-item mt-4">
								...
								<div className="col-6">
									<Autocomplete
										...
										onChange={(e) =>
											setFieldValue("groceryName", e.target.value)
										}
										onSelect={(val) => setFieldValue("groceryName", val)}
										placeholder="Grocery Name"
									/>
									<small>
										Name of the grocery item which you want to add in the
										system.{" "}
									</small>
							...
							<div className="row form-item mt-4">
								<div className="col-6">
									...
									<small>
										...
										if you want to put any comments to make it easy for user's
										to locate it. It can include directions as well.{" "}
									</small>
